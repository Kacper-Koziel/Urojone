window.addEventListener("scroll", function(){
    ...
    if(scrollPos > 1600)
    {
        let elements = document.getElementsByName("sc");
    ...
    if(scrollPos > 3100)
    {
        let elements = document.getElementsByName("frth");
    ...
    if(scrollPos > 3800)
    {
        let elements = document.getElementsByName("ffth");
    ...
    if(scrollPos > 4500)
    {
        let elements = document.getElementsByName("sxth");
