...
document.getElementById("tanInput").addEventListener("keydown", function (event) {
...
function toTryg()
{
    ...
    if(match)
    {
        ...
        if (match[2]) {
            ...
            imagPart = (imaginaryPart == "+i" || imaginaryPart == "i" ) ? 1 : imaginaryPart == "-i" ? -1 : parseFloat(imaginaryPart.replace('i', '')); 
        }

        if(!(checkLimits(realPart, -10000, 10000) && checkLimits(imagPart, -10000, 10000))) {
            let info = "Niepoprawne liczby. Spróbuj większych od -10 000 i mniejszych od 10 000";
            for(let i = 0; i < info.length; i++) {
                setTimeout(() => {
        ...
        let mod = Math.sqrt(realPart * realPart + imagPart * imagPart).toFixed(2);
        let rad = Math.atan2(imagPart, realPart);
        let deg = (rad * (180 / Math.PI)).toFixed(2);
...
document.getElementById("toTrygInput").addEventListener("keydown", function (event) {
...
document.getElementById("trygModInput").addEventListener("keydown", function (event) {
...
document.getElementById("trygArgInput").addEventListener("keydown", function (event) {
...
document.getElementById("multiFRInput").addEventListener("keydown", function (event) {
...
document.getElementById("multiSRInput").addEventListener("keydown", function (event) {
...
document.getElementById("multiFAInput").addEventListener("keydown", function (event) {
...
document.getElementById("multiSAInput").addEventListener("keydown", function (event) {
...
document.getElementById("divFRInput").addEventListener("keydown", function (event) {
...
document.getElementById("divSRInput").addEventListener("keydown", function (event) {
...
document.getElementById("divFAInput").addEventListener("keydown", function (event) {
...
document.getElementById("divSAInput").addEventListener("keydown", function (event) {
...
document.getElementById("powerRInput").addEventListener("keydown", function (event) {
...
document.getElementById("powerAInput").addEventListener("keydown", function (event) {
...
document.getElementById("powerNInput").addEventListener("keydown", function (event) {
